...
public class MainActivity extends AppCompatActivity implements Observer { //Esta es la clase del login y aqui pasa practicamente todoo!
    ...
    public void registrar(){
        ...
        if (inputPlayer.getText().length() < 1 ) {
            ...
            Communication.getInstance().send(new User(name, "", 0));
        }
    ...
    public void update(Observable observable, Object data) {
        Log.d("COMM", "update: OBSERVER NOTIFICADO ");
        ...
        if(data instanceof Integer) {
            if ((Integer) data == 3) {
                ...
                //Intent a = new Intent(MainActivity.this, Initiate.class);
                User u=new User(inputPlayer.getText().toString(), "", 0);
        ...
        if(data instanceof String){
            ...
            if(tempVar.equals("next")){
                Intent myIntent = new Intent(MainActivity.this, Control.class); /** Class name here */
